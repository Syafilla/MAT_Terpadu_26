      ...
      <div class="layout-container">
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('admin.rekap.atasnama') }}" class="menu-link">
                <i class="menu-icon bx bx-bar-chart-alt-2"></i>
                <div class="text-truncate">Rekap Hasil Data Arsip</div>
              </a>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a
                    ...
                    <div class="avatar avatar-online">
                      <img src="/img/avatars/admin.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
